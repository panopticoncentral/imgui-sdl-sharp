...
{
    public readonly unsafe struct ReferenceVector<TNative, TManaged> : IReadOnlyList<TManaged>
        ...
        where TManaged : struct, INativeReferenceWrapper<TManaged, TNative>
    {
        ...
        internal ReferenceVector(TNative* list, int count)
        {
            _vector = list;
            Count = count;
        }
        ...
        private sealed class VectorEnumerator : IEnumerator<TManaged>
        {
            ...
            public VectorEnumerator(ReferenceVector<TNative, TManaged> @this)
            {
                _this = @this;
                _index = -1;
            }
